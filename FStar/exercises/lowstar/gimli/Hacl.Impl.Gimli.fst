 ...
 *
 * To do so, you can run `make dist/gimli-test.exe -j N`
 *   (where N is the degree of parallelism you want) in the lowstar/
 *   directory and it should build the libvericrypt.a and gimli-test.exe
 *   files in the lowstar/dist directory
 *
